package com.anmory.cloudfile.mail;
 ...
 * @author Anmory
 * @description TODO
 * @date 2025-05-14 上午12:28
 */
@Slf4j
public class JavaxJavaMail {
    // 邮件协议
    ...
    // 发件人邮箱用户名
    private static final String emailAccount = "anmory@qq.com";
    // 发件人邮箱密码
    private static final String emailPassword = "mzwvdtmpapvwbadc";
    ...
    public static boolean sendEmail(Set<String> emails, String title, String content) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(emailAccount, "(阿梦云盘)李梦杰Anmory", "UTF-8"));
